...
const Hero = () => {
  return (
<section className="relative h-[600px] bg-[#FFE473] border-l-2 border-[#0095AF] px-[80px] flex items-center justify-between overflow-hidden">
  
  {/* Yazı alanı */}
  <div className="max-w-2xl mr-auto ml-[80px]">
    <h1 className="text-4xl font-bold text-[#332E2E] mb-4">
  ...
  <img
    ...
    alt="Özer Çetinkaya"
    className="absolute bottom-20 right-36 w-[380px] h-auto object-contain"
  />
</section>
